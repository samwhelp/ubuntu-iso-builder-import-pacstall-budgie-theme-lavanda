...
> [ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-lavanda/iso-profile/dist`
